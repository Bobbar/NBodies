...
namespace NBodies.Extensions
{
    public static class ControlExtentions
    {
        ...
        {
            Debug.WriteLine($@"[{label}] ms: {timer.Elapsed.TotalMilliseconds}  ticks: {timer.Elapsed.Ticks}");

            timer.Restart();
        }

        public static void PrintTicks(this Stopwatch timer)
        {
            Debug.WriteLine(timer.Elapsed.Ticks);
