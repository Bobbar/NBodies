...
namespace NBodies
{
	public static class MainLoop
	{
		...
		private static WaitableTimer _waitTimer = new WaitableTimer(IntPtr.Zero, null, new IntPtr(0x00000002), new IntPtr(0x1F0003));
		...
		private static void FPSLimiter(int targetFPS)
		{
			...
			if (_fpsTimer.IsRunning)
			{
				...
				float fps = (float)Math.Floor(ticksPerSecond / (double)(elapTime + waitTime));
