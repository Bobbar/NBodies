...
{
    public class OpenTKRenderer : RenderBase
    {
        ...
        public OpenTKRenderer(Control targetControl) : base(targetControl)
        {
            //_width = targetControl.ClientSize.Width;
            //_height = targetControl.ClientSize.Height;
            ...
            //targetControl.Parent.Controls.Add(_glControl);

        }

        private void _glControl_MouseWheel(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (e.Delta > 0)
                _camera.Fov -= 1;
            else
        ...
        {
            _glControl = (GLControl)_targetControl;

            _width = _targetControl.ClientSize.Width;
            _height = _targetControl.ClientSize.Height;
           // _targetControl.Visible = false;
            ...
            //parent.Controls.Remove(_targetControl);
            //parent.Controls.Add(_glControl);

            //_glControl.Dock = DockStyle.Fill;
            //_glControl.BringToFront();
           // _glControl.MakeCurrent();

            _camera = new Camera(Vector3.UnitZ, _width / (float)_height);
        ...
        private void _glControl_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        //private void _glControl_Click(object sender, EventArgs e)
        //{
        ...
        private void UpdateCamera()
        {
            ...
            //}
               ...
               Console.WriteLine($@"{_camera.Position}   {_camera.Fov}   {_camera.Pitch}   {_camera.Yaw}");
        }
        ...
        public override void DrawStats(string stats, Color foreColor, Color backColor)
        {
            // throw new NotImplementedException();
        }
